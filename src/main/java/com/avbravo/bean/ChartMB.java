...
public class ChartMB implements Serializable {
    ...
    public void createBarModel() {
        ...
        bgColor.add("rgba(255, 99, 132, 0.1)");
        bgColor.add("rgba(255, 159, 64, 0.1)");
        bgColor.add("rgba(255, 205, 86, 0.1)");
        bgColor.add("rgba(75, 192, 192, 0.1)");
        bgColor.add("rgba(54, 162, 235, 0.1)");
        bgColor.add("rgba(153, 102, 255, 0.1)");
        bgColor.add("rgba(201, 203, 207, 0.1)");
    ...
    public void createBarModel2() {
        ...
        BarChartDataSet barDataSet = new BarChartDataSet();
        barDataSet.setLabel("My First Dataset");
        barDataSet.setBackgroundColor("rgba(255, 99, 132, 0.1)");
        ...
        barDataSet2.setBackgroundColor("rgba(255, 159, 64, 0.1)");
    ...
    public void createRadarModel() {
        ...
        radarDataSet.setBackgroundColor("rgba(255, 99, 132, 0.1)");
        ...
        radarDataSet2.setBackgroundColor("rgba(54, 162, 235, 0.1)");
    ...
    public void createRadarModel2() {
        ...
        radarDataSet.setBackgroundColor("rgba(102, 153, 204, 0.1)");
        ...
        radarDataSet2.setBackgroundColor("rgba(255, 204, 102, 0.1)");
        ...
        angelLines.setColor("rgba(128, 128, 128, 0.1)");
    ...
    public void createMixedModel() {
        ...
        dataSet.setBackgroundColor("rgba(255, 99, 132, 0.1)");
